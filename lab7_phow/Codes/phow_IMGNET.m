function [accuracy]= phow_IMGNET(Train,Test,Classes,SpatialX,X)
...
global conf
conf.calDir = '/Users/FelipeLopez/Desktop/Lab_7/imagenet_tiny' ;
conf.dataDir = '/Users/FelipeLopez/Desktop/Lab_7/caltech101/data' ;
conf.autoDownloadData = true ;
conf.numTrain = Train ;
conf.numTest = Test ;
conf.numClasses = Classes;
conf.numWords = 600 ;
%conf.numSpatialX = [2 4] ;
conf.numSpatialX = SpatialX ;
...
if ~exist(conf.calDir, 'dir') || ...
   (~exist(fullfile(conf.calDir, 'abaya'),'dir') && ...
    ~exist(fullfile(conf.calDir, 'train', 'abaya')))
...
figure(1) ; clf;
subplot(1,2,1) ;
imagesc(scores(:,selTrain )) ; title('Scores') ;
set(gca, 'ytick', 1:length(classes), 'yticklabel', classes) ;
subplot(1,2,2) ;
imagesc(scores(:, selTest)) ; title('Scores') ;
set(gca, 'ytick', 1:length(classes), 'yticklabel', classes) ;
